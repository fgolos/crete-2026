(() => {
  ...
  "days": {
    "2026-08-11": {
      ...
      "mealSummary": "обед: Taverna Mesostrati / Ta Kochilia; ужин: Me Raki / To Limani",
      "schedule": {
        "departure": {
          "start": "05:15",
          "end": null,
      ...
      "sections": {
        ...
        "practical": {
          "items": [
            ...
            "Erotokritos на 15 августа считать главным кандидатом, но не гарантией: праздничный режим и загрузку проверить заранее.",
